...
public class NewTours_UserRegistartion_MultipleTestData 
{
...
FirefoxDriver driver;
	...
	public void UserRegistration() throws IOException
	{
		...
		FileInputStream file = new FileInputStream("C:\\Users\\aishsub\\Desktop\\AishwaryaSelenium\\WebTesting\\src\\com\\ExcelTestDataFiles\\UserRegistrationTestData.xlsx");
		...
		double k=r.getCell(8).getNumericCellValue();
		long y=(long)k;
		...
		String ExpectedUserName=r.getCell(10).getStringCellValue();
		...
		FileOutputStream file1 = new FileOutputStream("C:\\Users\\aishsub\\Desktop\\AishwaryaSelenium\\WebTesting\\src\\com\\ExcelTestResultFile\\UserRegistraionResultData2.xlsx");
